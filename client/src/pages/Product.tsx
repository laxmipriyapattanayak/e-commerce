...
const Product = (props: any) => {
  ...
  const imageUrl = apiHost + "/product/image/" + image;
  ...
  return (
    <div className="product">
      <Card sx={{ maxWidth: 250, maxHeight: 270 }}>
        <CardMedia sx={{ height: 100, width: 100 }} image={imageUrl} />
        <CardContent>
        ...
        <CardActions>
          <FavoriteIcon
            color={favorite.includes(_id) ? "error" : "secondary"}
